...
import com.zhangpeng.payment.core.domain.WeiXinPrePay;
...
//        if (!ObjectUtils.isEmpty(prePay.get("return_code"))) {
...
//        }
        ...
        String preSign = MD5Utils.encode(argPreSign).toUpperCase();
        return preSign;
    }
    ...
    public static boolean notifySign(Map<String, String> result, String sign, String partnerKey) {
        ...
        String notifySign = MD5Utils.encode(argNotifySign).toUpperCase();
    ...
    public static Map<String, Object> orderQuery(String outTradeNo, String appId, String MchId, String partnerKey) {
        ...
        paramMap.put("sign", MD5Utils.encode(signStr).toUpperCase());
