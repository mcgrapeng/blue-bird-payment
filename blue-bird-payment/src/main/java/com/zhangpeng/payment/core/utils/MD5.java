...
public class MD5 {
    ...
    public static void main(String [] args ){
        ...
        String ss = "test";
        System.out.println(MD5.encode32(ss));
        System.out.println(MD5.encode32ToUpperCase(ss));
        System.out.println(MD5.encode16(ss));
        System.out.println(MD5.encode16ToUpperCase(ss));
    }
}
